...
<template>
  ...
  <div v-else class="app">
    <header v-if="route.name !== 'recommend' && route.name !== 'course-planning' && route.name !== 'job-detail' && route.name !== 'minor-report' && route.name !== 'clear-cache' && route.name !== 'data-sync' && route.name !== 'about' && route.name !== 'learning-progress'" class="app-header">
      <h1>福小禾</h1>
