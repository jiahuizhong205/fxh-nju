...
sync_official_minor_data.py 以官网来源 S 级导入，因此不在此重复导入；毕业论文（设计）
校级规定在此作为独立来源导入。
"""
...
SOURCES = (
    {
        "title": "南京大学关于本科毕业论文（设计）工作的若干规定（2019年8月修订）",
        "path": ROOT / "scripts/fetched/policies/nju-undergraduate-thesis-rules-2019.txt",
        "raw_path": "repository://scripts/fetched/policies/nju-undergraduate-thesis-rules-2019.txt",
        "source_url": "https://jw.nju.edu.cn/_upload/article/files/7b/8f/6af8c2b749968eca4c4e18d09417/84ab2eb4-d2cd-4ca8-8fbb-b9b8b233d4d5.pdf",
        "trust_level": "S",
        "source_type": "regulation",
        "valid_from": datetime(2019, 10, 28),
        "valid_to": None,
        "is_active": True,
    },
    {
